...
gan_epochs = 50
syn_epochs = 200
exp_name = 'resnet_SfSNet_REAL_SH_GAN'
LOCAL_MACHINE = False
output_path = './resnet_SfSNet_REAL_SH_GAN/'
...
if train_GAN:
    ...
    trainGAN(lightingNet, R, D, featureNet, syn_image1, real_image, real_sh, fixed_input, sirfs_fixed_normal, real_image_mask_test, true_fixed_lighting, sirfs_fixed_sh, output_path = output_path, num_epoch = gan_epochs)
