    ...
    for epoch in range(0, num_epoch):
        ...
        for rD, rL in zip(rData, rLabel):
            ...
            for k in range(0, numGTrainer):
                ...
                G_loss = -lossfunctions.GANLoss(D_fake) + MU * lossfunctions.regressionLossSynthetic(G_predict, rL).sum()
        ...
        outShadingB = ShadingFromDataLoading(fixed_input, fixedSH)
...
# Training
'''
syn_net_train(featureNet, lightingNet, 1)
...
trainGAN(lightingNet, R, D, fs, real_image, real_sh)
